    ...
    >
      ...
      {open && (
        <div
          ref={tooltipRef}
          className={cn(
            'absolute z-[100] px-2 py-1 text-[10px] font-medium text-white bg-mn-card border border-mn-border rounded shadow-mn-panel whitespace-nowrap pointer-events-none animate-in fade-in zoom-in-95 duration-100',
            sideClasses[side],
            className
          )}
        >
          ...
          <div 
            className={cn(
              'absolute w-1.5 h-1.5 bg-mn-card border-b border-r border-mn-border transform rotate-45',
