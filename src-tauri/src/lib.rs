...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            repository_relationships::list_repository_relationships,
            repository_relationships::create_app_repository_relationship,
            ...
            repository_settings::get_repository_setting,
            repository_settings::set_repository_setting,
            ...
            workspace_file_tree::save_workspace_attachment,
